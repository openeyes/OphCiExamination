...
class Element_OphCiExamination_FurtherFindings extends \BaseEventTypeElement
{
	...
	public function relations()
	{
		return array(
			...
			'further_findings' => array(self::HAS_MANY, 'OEModule\OphCiExamination\models\OphCiExamination_FurtherFindings', 'further_finding_id', 'through' => 'further_findings_assignment'),
		);
	}
