...
/**
 * This is the model class for table "et_ophciexamination_extraocular_muscles".
 *
...
class Element_OphCiExamination_ExtraocularMuscles extends SplitEventTypeElement {
	public $service;
	...
	public function tableName() {
		return 'et_ophciexamination_extraocular_muscles';
	}
	...
	public function rules() {
		...
		return array(
				array('event_id, left_eom_id, right_eom_id, left_ct_distance_id, right_ct_distance_id, left_ct_near_id, right_ct_near_id, left_details, right_details, eye_id', 'safe'),
				// The following rule is used by search().
				// Please remove those attributes that should not be searched.
				array('id, event_id, left_eom_id, right_eom_id, left_ct_distance_id, right_ct_distance_id, left_ct_near_id, right_ct_near_id, left_details, right_details, eye_id', 'safe', 'on' => 'search'),
		);
	}
	
	public function sidedFields() {
		return array('eom_id, ct_distance_id, ct_near_id, details');
	}
	...
	public function attributeLabels() {
		return array(
				...
				'left_eom_id' => 'EOM',
				'right_eom_id' => 'EOM',
				'left_ct_distance_id' => 'CT Distance',
				'right_ct_distance_id' => 'CT Distance',
				'left_ct_near_id' => 'CT Near',
				'right_ct_near_id' => 'CT Near',
				'left_details' => 'Details',
