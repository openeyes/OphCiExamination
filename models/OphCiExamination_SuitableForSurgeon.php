...
/**
 * This is the model class for table "ophciexamination_cataractmanagement_suitable_for_surgeon".
 *
 * @property integer $id
 * @property string $name
 */
class OphCiExamination_SuitableForSurgeon extends BaseActiveRecordVersioned
{
	/**
