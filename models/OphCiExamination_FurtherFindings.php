...
/**
 * This is the model class for table "ophciexamination_further_findings".
 *
 * @property integer $id
...
class OphCiExamination_FurtherFindings extends \BaseActiveRecordVersioned
{
	...
	{
		return 'ophciexamination_further_findings';
	}
	...
	{
		$criteria = array(
				'join' => 'left join ophciexamination_further_findings_subspec_assignment on ophciexamination_further_findings_subspec_assignment.further_finding_id = t.id',
				'condition' => 'ophciexamination_further_findings_subspec_assignment.subspecialty_id is null',
		);
		if ($subspecialty) {
			$criteria['condition'] .= ' OR ophciexamination_further_findings_subspec_assignment.subspecialty_id = :subspecialty_id';
