...
<div class="element-fields element-eyes row">
	...
	<div class="element-eye left-eye column right side<?php if (!$element->hasLeft()) {?> inactive<?php }?>" data-side="left">
		<div class="active-form">
			<a href="#" class="icon-remove-side remove-side">Remove side</a>
			<?php echo $form->dropDownList($element, 'left_abnormality_id', 'OphCiExamination_PupillaryAbnormalities_Abnormality', array('empty' => '-- Select --'), false, array('label' => 3, 'field' => 6)) ?>
		</div>
		<div class="inactive-form">
			<div class="add-side">
				<a href="#">
