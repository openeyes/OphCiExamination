...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	<div class="element-fields row">
		...
		<?php echo $form->dropDownList($element, 'clinic_interval_id', $overallPeriods, array( 'prompt'=>'6 months'), false , array('label'=>4, 'field'=>3))?>
		<?php echo $form->dropDownList($element, 'photo_id', $overallPeriods, array('prompt'=>'6 months'), false , array('label'=>4, 'field'=>3))?>
		<?php echo $form->dropDownList($element, 'oct_id', $overallPeriods, array('prompt'=>'6 months'), false , array('label'=>4, 'field'=>3))?>
		<?php echo $form->dropDownList($element, 'hfa_id', $overallPeriods, array('prompt'=>'6 months'), false , array('label'=>4, 'field'=>3))?>
