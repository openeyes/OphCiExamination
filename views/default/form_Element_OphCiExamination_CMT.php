 ...
 */
?>
<?php $methods = CHtml::listData(OphCiExamination_CMT_Method::model()->findAll(array('order' => 'display_order')),'id','name') ?>
<div class="cols2 clearfix">
	...
	<div
		...
		<div class="activeForm">
			...
			<?php echo $form->textField($element, 'right_value', array('nowrapper' => true, 'size' => '6')) ?> &micro;m,
	...
	<div
		...
		<div class="activeForm">
			<a href="#" class="removeSide">-</a>
			<?php echo $form->textField($element, 'left_value', array('nowrapper' => true, 'size' => '6')) ?> &micro;m,
