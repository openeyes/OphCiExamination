...
<?php echo CHtml::dropDownList(get_class($element).'_'.$field.'_fraction', abs($element->$field) - (abs((int) $element->$field)), CHtml::listData(OphCiExamination_Refraction_Fraction::model()->findAll(array('order'=>'display_order')),'id','name'))?>
