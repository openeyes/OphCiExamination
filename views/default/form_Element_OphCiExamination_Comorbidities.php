...
<div class="sub-element-fields">
	...
	<div class="field-row comorbidities-multi-select">
		<?php echo $form->multiSelectList($element, 'comorbidities_items', 'items', 'id', CHtml::encodeArray(CHtml::listData(OphCiExamination_Comorbidities_Item::model()->activeOrPk($element->comorbidityItemValues)->findAll(array('order'=>'name')), 'id', 'name')), array(), array('empty' => '-- Add --', 'label' => 'Comorbidities', 'nowrapper' => true), false, true, 'No comorbidities',true,true)?>
	</div>
	<div class="field-row">
