...
<div class="sub-element-fields">
	<div class="field-row">
		...
		<div id="PCRRiskToggleRight">Right Eye - PCR Risk</div>
		<div id="PCRRiskToggleLeft">Left Eye - PCR Risk </div>
	</div>
	<div class="field-row">
