...
class m121217_152021_create_outcome_element extends CDbMigration
{
	public function up()
	{
		...
		$this->createTable('ophciexamination_outcome_status', array(
		...
		$this->insert('ophciexamination_outcome_status', array('name'=>'Follow-up', 'display_order' => '1', 'episode_status_id' => $fup->id, 'followup' => true));
		$this->insert('ophciexamination_outcome_status', array('name'=>'Discharge', 'display_order' => '2', 'episode_status_id' => $dcharg->id));
		...
		$this->createTable('et_ophciexamination_outcome', array(
				...
				'KEY `et_ophciexamination_outcome_status_fk` (`status_id`)',
				...
				'CONSTRAINT `et_ophciexamination_outcome_status_fk` FOREIGN KEY (`status_id`) REFERENCES `ophciexamination_outcome_status` (`id`)',
