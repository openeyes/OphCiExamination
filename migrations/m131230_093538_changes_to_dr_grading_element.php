...
class m131230_093538_changes_to_dr_grading_element extends CDbMigration
{
	public function up()
	{
		$exam = Yii::app()->db->createCommand()->select("*")->from("event_type")->where("class_name = :class_name",array(":class_name" => "OphCiExamination"))->queryRow();
	...
	public function down()
	{
		...
		$posterior_pole = Yii::app()->db->createCommand()->select("*")->from("element_type")->where("event_type_id = {$exam['id']} and class_name = 'Element_OphCiExamination_PosteriorPole'")->queryRow();
